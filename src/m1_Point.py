...
def run_test_get_number_of_moves_made():
    ...
    print()
    print('Expected for p1 moves made: 0')
    print('Actual for p1 moves made: ', p1.get_number_of_moves())
    print('Expected for p2 moves made: 0')
    print('Actual for p2 moves made: ', p2.get_number_of_moves())
...
def run_test_get_distance_from_start():
    ...
    p2 = Point(1, 1)
    print()
    print('p2 from start to (11, 1), should be about 0.0')
    print('Actually is:', p2.get_distance_from_start())
    ...
    p2.move_to(1, 1)
    print()
    print('p2 from start to (1, 1), should be about 10.0')
    print('Actually is:', p2.get_distance_from_start())
